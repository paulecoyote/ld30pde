...
x=$.rS()
w=new K.Hd(null,null,null,0,null,null,null)
w.x=z*2
w.y=y*2
w.jn=20
y=$.UV()
...
w=window
C.ol.hr(w)
C.ol.oB(w,W.VF(K.f4()))},"$0","eE",0,0,1],
...
J.yc($.eo,w.IV)
J.Wm($.eo)}},
LV:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
J.b0($.eo)
z=$.rS().length
...
p=q/(t*0.25)
o=q+p*0.4
for(n=0;n<t;++n){m=n*2*3.141592653589793/t
v=Math.cos(m)
...
x=r+v*o
J.Dg($.eo)
J.lJ($.eo,y,x,p,0,6.283185307179586,!1)
J.yc($.eo,u.fB)
J.Wm($.eo)}}J.Xi($.eo)},
...
$.eL=x*0.05+w*0.95
J.yc($.eo,"#000000")
J.mi($.eo,"FPS "+C.CD.yu(C.CD.UD(x)),10,10)}$.fV=z}},"$1","f4",2,0,9],
Hd:{
"^":"a;x,y,jn,u7,IV,fB,G1"}},1],])

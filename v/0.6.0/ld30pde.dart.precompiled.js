...
if($desc instanceof Array)$desc=$desc[1]
em.prototype=$desc
function Hd(CW,SE,xB,Hn,Rg){this.CW=CW
this.SE=SE
this.xB=xB
this.Hn=Hn
...
Hd.prototype.sSE=function(v){return this.SE=v}
...
function BQ(u7,vY,ZX,lv,Xg,GB,Ly,Yu){this.u7=u7
this.vY=vY
this.ZX=ZX
this.lv=lv
this.Xg=Xg

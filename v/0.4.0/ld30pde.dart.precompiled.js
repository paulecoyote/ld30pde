...
J.bs($.eo,y[4])
x=$.Yw
for(w=null,v=null,u=null,t=0,s=0,r=0,q=0,p=0,o=0,n=0,m=0,l=0,k=0,j=null,i=0;i<x;++i){z=$.rS()
if(i>=z.length)return H.e(z,i)
if(z[i].gCW()!==!0)continue
z=$.jS()
if(i>=z.length)return H.e(z,i)
w=z[i]
if(w.gXQ()<0)continue
...
eN:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o
J.wg($.Ql(),0)
...
t.push(s[u])}}t=$.Ql()
s=t.length
if(s===0);else for(t=new H.a7(t,s,0,null);t.G();)if(J.de(t.lo,$.Ro())){r=$.Ro().gSE()
q=$.Ro().gHn()
q.Ly=q.gLy()+1
if(r.gXQ()===0){r=$.Ro().gSE()
$.Ro().gHn().sYu(16)
r.sXQ(1)
K.R6($.Ro(),1)}else{s=q.Ly
p=q.Yu
if(s>p){q.Yu=p*2
s=q.u7
o=(s|1)>>>0
...
x=$.eL
if(x==null){$.eL=y
x=y}if(typeof x!=="number")return x.U()
$.eL=y*0.05+x*0.95}y=$.Ap
if(y==null)$.Ap=a
else if(!J.de(a,y)){y=J.xH($.Ap,a)
w=$.GO&&$.rM!=null
...
jr:[function(a){return new K.Hd(null,null,null,null)},"$1","ze",2,0,11],
qX:[function(a){return new K.Up(!1,"","",-1,0,"",H.VM([],[P.qU]))},"$1","pU",2,0,12],
JN:[function(a){return new K.BQ(0,0,0,0,0,3.141592653589793,0,0)},"$1","DF",2,0,13],
vd:[function(a){return new K.ud(0,0,0,0)},"$1","i4",2,0,14],
Hd:{
"^":"a;CW<,SE@,Hn<,Rg",
...
I.$lazy($,"playerFlower","k4","Ro",function(){return new K.Hd(null,null,null,null)})
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function Hd(CW,SE,Hn,Rg){this.CW=CW
this.SE=SE
this.Hn=Hn
...
function ud(x,y,jn,tj){this.x=x
this.y=y
this.jn=jn
